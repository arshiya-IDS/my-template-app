          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="billing-page-view">
                <img
                  src="./assets/images/Subscription-img/03svg.svg"
                  width="100%"
                  alt=""
                />
              </div>
            ...
            <div className="col-md-4">
              <div className="billing-page-text-and-features">
                <h3 className="subscription-titles">Gold</h3>
            ...
            <div className="col-md-4">
              <div className="price-detail">
                ...
                <div className="d-flex justify-content-around">
                  ...
                  <p className="pl-3 mb-3">$ 30</p>
                </div>

                <div className="d-flex justify-content-around">
                  <p className="mb-3">Discount</p>
                  <p className="pl-5 mb-3">$ -6</p>
                </div>
                ...
                <p className="mt-3 pl-4 mb-3" style={{ color: "green" }}>
                  <strong>You will save $6 on this order</strong>
                </p>
              </div>
...
export default BillingPageGold;
