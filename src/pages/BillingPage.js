          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="billing-page-text-and-features">
                <h3 className="subscription-titles">Free</h3>
                <div className="subscription-check mt-3">
                  <ul className="checked-list">
                    ...
                    {/* <li><img src="./assets/images/check.svg" alt="" /> Free plan</li> */}
                    <li>
                      <img src="./assets/images/check.svg" alt="" /> Charges
                      $0.00
                    </li>
                    <li>
                      <img src="./assets/images/check.svg" alt="" /> 3 Month
                      Validity
                    </li>
                  </ul>
                </div>
            ...
            <div className="col-md-4">
              <div className="price-detail">
                ...
                <div className="d-flex justify-content-around">
                  ...
                  <p className="pl-3 mb-3">$ 00</p>
                </div>

                <div className="d-flex justify-content-around">
                  <p className="mb-3">Discount</p>
                  <p className="pl-5 mb-3">$ 00</p>
                </div>
                ...
                <p className="mt-3 pl-4 mb-3" style={{ color: "green" }}>
                  <strong>You will save 100% on this order</strong>
                </p>
              </div>
