...
function AuctionWinner() {
  return (
    ...
    <div className="subscription-first-section">
        <img src="./assets/images/subscriptin-bg.webp" class="subs-bread"
            style={{width: "100%", position: "absolute",left: "0"}} alt=""/>
    </div>
            ...
            <div className="col-md-7 px-5 py-4 ml-3" style={{ border: "1px dotted grey" }}>
              <div className="row">
                ...
                <div className="subscription-planes d-flex justify-content-between w-100 mt-5">
                  <h5 className="pl-3">Price (1 item)</h5>
                  <p className="pr-3">
                    <strong>$39</strong>
                  </p>
                </div>
